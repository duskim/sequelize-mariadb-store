...
//@ts-ignore
const Session_ts_1 = __importDefault(require("./models/Session.ts"));
...
function default_1(Store) {
    class ExpressSessionStore extends Store {
        constructor(options) {
            ...
            (0, Session_ts_1.default)(this.client);
        ...
        all(cb) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this._wrapInTryCatchBlock(() => __awaiter(this, void 0, void 0, function* () {
        ...
        get(sid, cb) {
            return __awaiter(this, void 0, void 0, function* () {
                this._wrapInTryCatchBlock(() => __awaiter(this, void 0, void 0, function* () {
        ...
        set(sid, sess, cb) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this._wrapInTryCatchBlock(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (ttl > 0) {
                        const [session, created] = yield this._getModel(MODEL_NAME).upsert({
                            sid,
        ...
        _hasExpiration(sess) {
            var _a, _b;
            return (sess && sess.cookie && ((_a = sess === null || sess === void 0 ? void 0 : sess.cookie) === null || _a === void 0 ? void 0 : _a.expires) && !!((_b = sess === null || sess === void 0 ? void 0 : sess.cookie) === null || _b === void 0 ? void 0 : _b.expires));
        }
        _getTTLInMilli(sess) {
            let ttl = this.ttl;
            if (this._hasExpiration(sess)) {
